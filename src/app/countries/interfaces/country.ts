...
export class Convert {
  public static toSearchReponse(json: string): Country[] {
    return cast(JSON.parse(json), a(r("SearchReponse")));
  }

  public static searchReponseToJson(value: Country[]): string {
    return JSON.stringify(uncast(value, a(r("SearchReponse"))), null, 2);
  }
}
